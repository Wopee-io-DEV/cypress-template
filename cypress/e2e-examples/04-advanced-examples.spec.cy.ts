...
context("Wopee integration smoke", () => {
  ...
  it("Smoke 2", () => {
    ...
    cy.get("#navbar").wopeeTrack({
      stepName: "Smoke 2 - Separate element - 1",
    });

    cy.wopeeTrack({
      stepName: "Smoke 2 - With additional options - 1",
  ...
  it("Smoke 3", () => {
    ...
    cy.get(
      "body > div.container.content-container > div > div > div:nth-child(4) > div > ul > li:nth-child(1)"
    )
      .wopeeTrack({
        stepName: "Smoke 3 - Type: Before - 1",
        scenarioName: "cy-smoke-3",
      })
      .click()
      .wopeeTrack({
        stepName: "Smoke 3 - Type: After - 1",
        scenarioName: "cy-smoke-3",
      });
  });
});
